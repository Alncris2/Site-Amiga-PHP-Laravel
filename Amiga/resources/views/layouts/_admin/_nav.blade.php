        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('site.home') }}" target="_blank" class="nav-link icon d-flex align-items-center"><i class="ion-ios-home mr-2"></i> Site</a></li>
                    @if(Auth::guest())
                    ...
                    <li class="nav-item d-flex dropdown">
                        <a class="nav-link d-flex align-items-center dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->name }}</a>
                    ...
                    <li class="nav-item"><a href="{{ route('admin.login.sair') }}" class="nav-link icon d-flex align-items-center">Sair</a></li>
                    @endif
                </ul>
            </div>
        </div>
